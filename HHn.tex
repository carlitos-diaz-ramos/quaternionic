...
We also derive some formulas for the maps $J_{X}\colon \g{g}_{\alpha}\to\g{g}_{\alpha}$ in terms of the Cartan involution.
...
We make the usual identifications $U\equiv u$, $V\equiv v$ and $W\equiv w$.
Then, we have 
\[
[W,[U,\theta V]]\equiv 
2\langle u,v\rangle_{\H^{n}}w-2w\Im u^*v
+2\langle v,w\rangle_{\H^{n}}u-2u\Im v^*w
-2\langle u,w\rangle_{\H^{n}}v-2v\Im u^*w,
\]
$[U,V]\equiv u^*v-v^*u=-2\Im u^*v$,
$J_{[U,V]}W\equiv 2rw\Im u^*v$,
and $\langle U,V\rangle_{\g{g}}=2r^2\langle u,v\rangle_{\H^n}$.
Combining all these equations yields
\[
[W,[U,\theta V]]=
\frac{1}{r^2}\Bigl(\langle U,V\rangle_{\g{g}} W+\langle V,W\rangle_{\g{g}} U-\langle U,W\rangle_{\g{g}} V\Bigr)
+\frac{1}{r}\Bigl(-J_{[U,V]}W+J_{[V,W]}U-J_{[U,W]}V\Bigr).
\]
In particular, if $W=U$ we get
\[
\ad(U)^2(\theta V)=
...
We also identify $X\equiv\lambda$, $Y\equiv\mu$, and $Z\equiv\nu$.
By direct calculation,
\[
[[X,\theta Y],Z]\equiv
4\lambda\mu\nu+4\nu\mu\lambda
=-8\langle\mu,\nu\rangle_\H\lambda+8\langle\lambda,\nu\rangle_\H\mu-8\langle\lambda,\mu\rangle_\H\nu.
\]
We also have $\langle X,Y\rangle_{\g{g}}=2r^2\langle\lambda,\mu\rangle_\H$. 
Combining this equalities yields
\[
[[X,\theta Y],Z]=\frac{4}{r^2}\Bigl(
-\langle Y,Z\rangle_{\g{g}} X
+\langle X,Z\rangle_{\g{g}} Y
-\langle X,Y\rangle_{\g{g}} Z
\Bigr).
\]
In particular, 
$\ad(X)^2(\theta Y)=\frac{8}{r^2}\langle X,Y\rangle_{\g{g}} X-\frac{4}{r^2}\lvert X\rvert_{\g{g}}^2 Y$.
